...
//const Decisao = () => {
  ...
  //useEffect(() => {
    //fetch('http://localhost:8000/api/rodadas/ativas/')
      //.then((res) => {
        //if (!res.ok) {
  ...
  //if (!rodadaAtiva) return <p>Carregando rodada ativa...</p>;

  //return (
    //<div>
      //<h2>Painel de Decisão</h2>
      //<PainelDecisao rodada={rodadaAtiva} />
    //</div>
  //);
//};
